...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(doom-themes dockerfile-mode)
   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()
   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(spaceline evil-search-highlight-persist)
